...
class Pages extends Component {
  ...
  render () {
        ...
        <div className="padding-top-15px"></div>
            ...
            <div className="a-s-p-place">
              <div className="a-s-p-top">
                <div className="grid grid-2x">
                  <div className="col-1">
                    <div className="margin-left-15px margin-top-10px">
          ...
          <div className="a-s-p-side">
            <div className="a-s-p-place">
              ...
              <div className="a-s-p-mid a-s-p-pad">
                <div className="image image-middle background-green margin-bottom-10px"></div>
                <div className="txt-site txt-14 txt-main txt-bold">
                  Name Of Items
                </div>
                <div className="txt-site txt-11 txt-thin color-orange">
                  Rp. 25.000.000
                </div>
                <div className="margin-10px txt-site txt-11 txt-primary">
                ...
                {/*<div className="margin-10px">
                  ...
                  <div className="grid grid-2x">
                    ...
                    <div className="col-2 content-right">
                      <span className="txt-site txt-10 txt-bold color-green">
                        45
                      </span>
                    </div>
                  </div>
