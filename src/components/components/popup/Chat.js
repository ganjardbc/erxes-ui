    ...
    for (let index = 0; index < val; index++) {
      dt.push(
        <div className="chat-profile" onClick={ this.opRoomChat }>
          <div className="col-1">
            <div className="image image-40px image-circle background-grey" />
          </div>
          <div className="col-2">
        ...
        <div>
          ...
          <div className="card-message c-m-left">
            <div className="c-m-col-1">
              <div className="image image-45px image-circle background-grey" />
            </div>
        ...
        {(this.state.sttChatPopup) ? (
          <div className="chat-popup">
            ...
            <div className="c-p-list">
              ...
              <div className="c-p-mid gradient-blue">
                { this.cardProfile(3) }
              </div>
            </div>
            ...
            <div className={ this.state.roomChat }>
                ...
                <div className="grid grid-2x">
                  <div className="col-1">
                    ...
                    <div style={{display: 'inline-block', verticalAlign: 'center'}}>
                      <div className="txt-site txt-11 txt-bold txt-white">
                        Full Name
                      </div>
                    </div>
                  </div>
              ...
              <div className="c-p-min gradient-blue">
                { this.cardMessage(2) }
              </div>
              <div className="c-p-bot">
                <input 
                  className="txt txt-trans-color txt-small txt-no-shadow color-white"
                  required 
